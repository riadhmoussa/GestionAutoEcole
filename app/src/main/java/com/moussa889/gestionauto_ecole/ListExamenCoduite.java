...
public class ListExamenCoduite extends AppCompatActivity {
    public static ArrayList<AdapterItemsListeExamen> listnewsData;
    public static ListExamenCoduite.MyCustomAdapter myadapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_examen_coduite);
    ...
    void LoadData(){
        ...
        ListView lsNews=(ListView)findViewById(R.id.list_examen_conduite);
